...
from rotation.data_extractor import get_rroidb,vis_image
...
if __name__ == '__main__':
    ...
    print __file__,'roidb[0]',roidb[2]
    vis_image(roidb[2]['image'],roidb[2]['boxes'])
    blobs = r_get_minibatch([roidb[2]], 2)
    # (0, 3, 1, 2)  == > ()
